  ...
  return (
    <div className="card">
      ...
      <div className="card-main">
        <div className="card-main__subtitle">Smart People Think To Get Ahead</div>
        <div className="card-main__info d-flex">
          <span className="card-main__info-author">
            By: <strong> Ewrin Jonson</strong>
          </span>
          <span className="card-main__info-date">
            <img src={iconClock} alt="" />
            <strong>Mar 23, 2021</strong>
          </span>
          <span className="card-main__info-like">
            <img src={iconHeart} alt="" />
            <strong>27 likes</strong>
          </span>
        </div>
        <h4 className="card-main__description">
